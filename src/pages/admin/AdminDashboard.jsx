            ...
            <MaterialCard>
              <div className='p-4 bg-purple-600/20 rounded-xl border-b-4 border-purple-300'>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="font-semibold text-lg uppercase">Total Courses</p>
            ...
            <MaterialCard>
              <div className='p-4 bg-purple-600/20 rounded-xl border-b-4 border-purple-300'>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="font-semibold text-lg uppercase">Enroll Users</p>
                    <div className="text-3xl flex items-center text-purple-400">
            ...
            <MaterialCard>
              <div className='p-4 bg-purple-600/20 rounded-xl border-b-4 border-purple-300'>
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className="font-semibold text-lg uppercase">add Course</p>
                    <div className="text-3xl flex items-center text-purple-400">
                      <p className='font-bolder font-bold text-black'>$3249</p>
                      <span><MdArrowDropDown size={30} /> </span>
                    </div>
